...
class LocalUsersDb
  ...
  def create_user
    loop do
      ...
      return false if chk_manage_symbols('input_data', @user_name) == false
    ...
    loop do
      ...
      return false if chk_manage_symbols('input_data', @psw1) == false
    ...
    loop do
      ...
      return false if chk_manage_symbols('input_data', psw2) == false
      break if @psw1 == psw2
