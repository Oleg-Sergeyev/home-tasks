...
MenuItem.new(MESSAGE_PRESS_KEY, OPERATING_SYMBOLS, descr, input, :task1)

clear
descr = "\nЗадания №2. День недели по номеру"
input = "\nInput day number (1-7): "
MenuItem.new(MESSAGE_PRESS_KEY, OPERATING_SYMBOLS, descr, input, :task2)
...
MenuItem.new(MESSAGE_PRESS_KEY, OPERATING_SYMBOLS, descr, input, :task3)

clear
descr = "\nЗадания №4,5,6. Что введнено? Если число то тип, положительное/отрицательное?"
input = "\nEnter something: "
MenuItem.new(MESSAGE_PRESS_KEY, OPERATING_SYMBOLS, descr, input, :task4)
